...
%>
  ...
  <body>
    <div class="wrapper">
      <header>
        ...
        <p>Anchor CMS documentation</p>
         ...
         <!-- <a href="#tray" class="mini-menu"><img src="img/menu.png" class="linky" alt="Menu" title="Navigate page"></a> -->
      </header>
    ...
    <pre><code>?php echo PHP_VERSION; // version.php</code></pre>
    <p>This should print a number to your screen, which should exceed 5.3.6.</p>
    <p>If you don’t have the necessary requirements, you will not be able to install Anchor. You should contact your host to upgrade.
    </p>
  </section>
      <footer>
